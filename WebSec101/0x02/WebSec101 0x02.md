...
Örneğin biz kendi adresimizi web uygulamasına kaydediyoruz ama aynı zamanda bir başkasının adresini görmemeliyiz. Eğer web uygulamasında böyle bir zafiyet var ise ve kendimizin dışında başkasının adresini de görebiliyorsak  burada IDOR kategorisinde bir zafiyet olduğunu söyleyebiliriz. En basit haliyle IDOR zafiyeti budur.
...
* Bu uygulamalı anlatımda zafiyetli tasarlanmış bir web uygulaması üzerinden anlatım gerçekleştireceğiz.
